...
# Import data
x_tr_data = pd.read_excel(r'C:\Users\Gaming\Desktop\Ders\Damar Tıkanıklığı\AI\1030\Initial_parameter_training_x.xlsx', header = None)
X_Train = np.array(x_tr_data)

x_veri_data = pd.read_excel(r'C:\Users\Gaming\Desktop\Ders\Damar Tıkanıklığı\AI\1030\Initial_parameter_test_x.xlsx', header = None) 
X_Veri = np.array(x_veri_data)

y_train_data = pd.read_excel(r'C:\Users\Gaming\Desktop\Ders\Damar Tıkanıklığı\AI\1030\Initial_parameter_training_y.xlsx', header = None) 
y_Train = np.array(y_train_data)

y_veri_data = pd.read_excel(r'C:\Users\Gaming\Desktop\Ders\Damar Tıkanıklığı\AI\1030\Initial_parameter_test_y.xlsx', header = None) 
